    ...
    $.fn.extend({
        imageframer: function(options) {
            ...
            var defaults = {
                ...
                autolink: true,             // Boolean value.
                customClass: null,     // Enables you to insert class in the outermost element generated by javascript ( .if-equalizer ).
            ...
            if ( o.disable !== true ) {
                ...
                obj
                 .addClass('if-image')
                 .wrap(
                    '<div class="if-equalizer '+ ( o.customClass || '' ) +'">' +
