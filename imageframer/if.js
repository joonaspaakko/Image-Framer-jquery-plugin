  ...
  $.fn.extend({
    imageframer: function(options) {
      ...
      var defaults = {
        ...
        path: 'imageframer/frames/',
        showAll: $('body'),           // Appends all frames inside the target element. The purpose is to get a quick preview to help with decision process.
        callback: function() {}
      };
      ...
      return this.each(function() {
        ...
        if ( o.disable !== true ) {
          ...
          background = [ ' background-image: url( ' + o.path + frameType + '-' + frameSize + '/', '.png ); ' ];
